...
let
  ...
  staticGccRuntime = runCommand "bun-static-gcc-runtime" { } ''
    mkdir -p $out/lib
    libgcc=$(${llvmPackages.stdenv.cc}/bin/${llvmPackages.stdenv.cc.targetPrefix}cc -print-libgcc-file-name)
...
llvmPackages.stdenv.mkDerivation (finalAttrs: {
  ...
  env.NIX_LDFLAGS = lib.optionalString isStatic "-L${staticGccRuntime}/lib";
